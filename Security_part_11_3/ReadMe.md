...
У нас уже есть установленный и настроенный KeyCloak (аж целых 3-и версии такового, см. предыдущие версии приложения), 
...
Как уже было упомянуто выше, мы возьмем один из прошлых проектов Security_part_10_1 и вырежем из него все лишнее,
возможно что-то и оставим. Самое важно это подтянуть нужные зависимости, настроить цепочку фильтров безопасности и
