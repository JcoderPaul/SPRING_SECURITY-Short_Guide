...
class WireMockCardsControllerIT extends TestContainerInit {
    ...
    @Test
    @SneakyThrows
    void getCardDetails_ShouldReturnDtoList_JwtAdminAuth_Test() {
    ...
    @Test
    @SneakyThrows
    void getCardDetails_ShouldReturnForbidden_JwtNotAdminAuth_Test() {
        /* Генерация JWT токена */
    ...
    @Test
    @SneakyThrows
    void getCardDetails_ShouldReturnUnauthorized_Test() {
    ...
    @Test
    @SneakyThrows
    void getCardDetails_ShouldReturn_4xx_EmptyToken_Test() {
        mockMvc.perform(get("/api/myCards"))
