...
class WireMockAdminControllerIT extends TestContainerInit {
    ...
    @Test
    public void getAllClient_ShouldReturnDtoList_JwtClaimWithAdmin_Test() throws Exception {
        String jwt = JwtTestUtils.generateJWT(EXIST_EMAIL, rsaJsonWebKey, wireMockServer, realmAccessClaimsAdmin);

        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/api/admin/getAllClient")
    ...
    @Test
    @SneakyThrows
    void getAllClient_ShouldReturnUnauthorized_Test() {
    ...
    @Test
    @SneakyThrows
    void getAllClient_ShouldReturn_4xx_EmptyToken_Test() {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/admin/getAllClient"))
