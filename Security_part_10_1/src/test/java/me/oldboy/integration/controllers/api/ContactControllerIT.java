...
class ContactControllerIT extends TestContainerInit {
    ...
    @Test
    @SneakyThrows
    @WithMockUser(roles = TEST_STR_ROLE_USER)
    void getAllContacts_ShouldReturnForbidden_NotAdminAuth_Test() {
    ...
    @SneakyThrows
    @WithUserDetails(value = EXIST_EMAIL, userDetailsServiceBeanName = "clientDetailsService")
    void getContactsIfConditionIsGood_ShouldReturnForbidden_NotExistingCity_Test() {
        String testCity = "Ufa";
