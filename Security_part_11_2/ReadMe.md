...
Вариант настройки выхода из приложения - [LOGOUT (описание настройки)](https://github.com/JcoderPaul/SPRING_SECURITY-Short_Guide/blob/master/Security_part_11_2/DOC/Spring_Security_and_KeyCloak_Logout.md).
