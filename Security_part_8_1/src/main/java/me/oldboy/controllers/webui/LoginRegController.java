...
public class LoginRegController {
    ...
    @GetMapping("/login")
    public String clientLoginPage(Model model, @AuthenticationPrincipal UserDetails userDetails){
        if (userDetails != null){
            model.addAttribute("user", userDetails);
            return "redirect:/webui/hello";
        } else {
    ...
    @GetMapping("/hello")
    public String getHelloPage(Model model, @AuthenticationPrincipal UserDetails userDetails){
        model.addAttribute("user", userDetails);
        return "/hello.html";
    }
