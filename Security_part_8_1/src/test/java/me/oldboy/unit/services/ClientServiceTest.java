...
class ClientServiceTest {
    ...
    void setTests(){
        ...
        clientFromBase = new Client(1L, TEST_EMAIL, TEST_PASS, Role.ROLE_USER, clientDetailsFromBase);
    ...
    void checkReturnedClientReadDto_SaveClientTest() {
        ...
        assertAll(
                ...
                () -> assertThat(Role.ROLE_USER).isEqualTo(capturedClient.getRole())
        ...
        assertAll(
                ...
                () -> assertThat(Role.ROLE_USER.name()).isEqualTo(returnedClientDto.getRole())
        );
    }
    ...
    @Test
    void checkReturnedOptionalEmpty_FindByEmailTest() {
