    ...
    */
    ...
    void shouldReturn_4xx_NotValidDto_RegistrationClientTest() {
        mockMvc.perform(post("/admin/regClient")
                ...
                .andExpect(status().is4xxClientError())
                .andExpect(content().string(containsString("\"pass\" : \"Field size value can be between 2 and 64")))
                .andExpect(content().string(containsString("\"email\" : \"Standard e-mail structure - email_name@email_domain.top_lavel_domain")));
    }
}