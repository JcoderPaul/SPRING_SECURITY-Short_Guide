...
NoticesController.java, доступ к нему открыт для всех в конфигураторе безопасности. Проверить это легко из браузера и PostMan-a.
...
[CORS Error example.jpg](DOC/JPG/CORS/CORS Error example.jpg)
...
[CORS is configured on Spring BackEnd App.jpg](DOC/JPG/CORS/CORS is configured on Spring BackEnd App.jpg)
...
- [см. форма аутентификации](DOC/JPG/CSRF/No_CSRF_Security_LoginForm.jpg);
- [см. форма регистрации](DOC/JPG/CSRF/No_CSRF_Security_RegForm.jpg);
...
- [см. форма аутентификации](DOC/JPG/CSRF/With_CSRF_SecurityToken_LoginForm.jpg);
- [см. форма регистрации](DOC/JPG/CSRF/With_CSRF_SecurityToken_RegForm.jpg);
