...
class BalanceServiceTest {
    ...
    void shouldReturnRightListSize_ReadAllTransactionByClientId_Test() {
        ...
        Integer originalSize = testList.size();
        Integer expectedSize = balanceService.readAllTransactionByClientId(clientId).size();
    ...
    void shouldReturnTransactionReadDtoListElement_ReadAllTransactionByClientId_Test() {
        ...
        boolean isTrueOrFalse = balanceService.readAllTransactionByClientId(clientId).get(0) instanceof TransactionReadDto;
